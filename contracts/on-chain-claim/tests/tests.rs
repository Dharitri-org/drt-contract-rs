...
use dharitri_sc::types::{ManagedAddress, TokenIdentifier};
...
fn check_token_identifier() {
    ...
    let roles: Vec<String> = vec!["DCTRoleNFTBurn".to_string()];
    ...
    world
        .set_state_step(
            SetStateStep::new()
                ...
                .put_account(
                    USER1_ADDR,
                    Account::new().nonce(1).dct_nft_balance(
                ...
                .put_account(
                    ...
                    Account::new()
                        ...
                        .owner(OWNER_ADDR)
                        .dct_roles(TOKEN_IDENTIFIER_EXPR, roles),
                )
                .block_epoch(20)
    ...
    world
        ...
        .whitebox_call_check(
            ...
            ScCallStep::new()
                .from(USER1_ADDR)
                .to(SC_ADDR)
                .dct_transfer(TOKEN_IDENTIFIER_EXPR, 1, "1")
                .no_expect(),
            |sc| {
                sc.claim_and_repair();
            },
        ...
        .whitebox_call_check(
            ...
            ScCallStep::new()
                .from(USER1_ADDR)
                .to(SC_ADDR)
                .dct_transfer(TOKEN_IDENTIFIER_EXPR, TOKEN_NONCE, "1")
                .no_expect(),
            |sc| {
                sc.claim_and_repair();
            },
        ...
        .whitebox_call_check(
            ...
            ScCallStep::new()
                .from(USER1_ADDR)
                .to(SC_ADDR)
                .dct_transfer(OTHER_TOKEN_IDENTIFIER_EXPR, 1, "1")
                .no_expect(),
            |sc| {
                sc.claim_and_repair();
            },
        ...
        .whitebox_call_check(
            ...
            ScCallStep::new()
                .from(USER1_ADDR)
                .to(SC_ADDR)
                .dct_transfer(TOKEN_IDENTIFIER_EXPR, TOKEN_NONCE, "2")
                .no_expect(),
            |sc| {
                sc.claim_and_repair();
            },
