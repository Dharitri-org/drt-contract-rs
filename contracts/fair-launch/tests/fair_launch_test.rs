...
fn transfer_user_test() {
    ...
    fl_setup.b_mock.set_dct_balance(
    ...
    fl_setup
        .b_mock
        .check_dct_balance(&fl_setup.first_user_address, TOKEN_ID, &rust_biguint!(0));

    fl_setup.b_mock.check_dct_balance(
    ...
    fl_setup
        .b_mock
        .check_dct_balance(&fl_setup.owner_address, TOKEN_ID, &rust_biguint!(400));
}
...
fn transfer_sc_ok_test() {
    ...
    fl_setup
        .b_mock
        .check_dct_balance(cf_wrapper.address_ref(), TOKEN_ID, &rust_biguint!(600));
...
fn transfer_sc_fail_test() {
    ...
    fl_setup
        .b_mock
        .check_dct_balance(cf_wrapper.address_ref(), TOKEN_ID, &rust_biguint!(0));

    fl_setup
        .b_mock
        .check_dct_balance(&fl_setup.owner_address, TOKEN_ID, &rust_biguint!(0));
}
...
fn buy_token_test() {
    ...
    fl_setup
        .b_mock
        .check_dct_balance(&fl_setup.first_user_address, TOKEN_ID, &rust_biguint!(50));
...
//     fl_setup
//         .b_mock
//         .check_dct_balance(&fl_setup.first_user_address, TOKEN_ID, &rust_biguint!(30_000));
